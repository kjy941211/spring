...
public class SampleController {
    ...
    public void basicOnlyGet() {
        ...
        // 요청주소와 views 밑에 파일이름이 같다면 String으로 return안해도 됨
    ...
    public void basic() {
        ...
        // forward 라고 함 ==> 결과를 넣는 jsp 페이지가 필요하다
    ...
    public String ex01(String name,@RequestParam("age") int age2) {
        ...
        // @RequestParam("파라메터이름") int 넣고 싶은 변수 이름
    ...
    // 컨트롤러 함수 호출 시 입력파라메터로 넣은 dto는
    // view까지 전달됨. Model의 속성으로 추가가 됨
    // 주의점!! 변수명을 첫 글자만 클래스 이름과 다르게 소문자로 만들어야함
